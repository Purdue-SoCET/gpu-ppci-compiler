...
class Instr_Type(MultiValueEnum):
    R_TYPE = Bits(bin="0000", length=4), Bits(
        bin="0001", length=4
    )  # 0000, 0001
    I_TYPE = (
        Bits(bin="0010", length=4),
        Bits(bin="0011", length=4),
        Bits(bin="0100", length=4),
    )  # 0010, 0011, 0100
    F_TYPE = Bits(bin="0101", length=4)  # 0101 (FP/conversion operations)
    S_TYPE = Bits(bin="0110", length=4), Bits(
        bin="0111", length=4
    )  # 0110, 0111
    B_TYPE = Bits(bin="1000", length=4), Bits(
        bin="1001", length=4
    )  # 1000, 1001
