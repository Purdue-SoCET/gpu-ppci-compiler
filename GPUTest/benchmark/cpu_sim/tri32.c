...
int main(int argc, char** argv) {
    ...
    //32 thread
    // Override pVerts for an 8x4 bounding box (32 pixels / threads)
    // Span 7 in X and 3 in Y → 8 and 4 after ±0.5 rounding
    pVerts[0].coords.x = 100.0f;  pVerts[0].coords.y = 100.0f;  pVerts[0].coords.z = 1.0f;
    pVerts[1].coords.x = 107.0f;  pVerts[1].coords.y = 100.0f;  pVerts[1].coords.z = 1.0f;
    pVerts[2].coords.x = 100.0f;  pVerts[2].coords.y = 103.0f;  pVerts[2].coords.z = 1.0f;
