...
<<<<<<< HEAD:GPUTest/benchmark/cpu_sim/onetri.c
...
>>>>>>> 456190c94367dc299bafdde5c53d4d132dc7e57e:GPUTest/benchmark/cpu_sim/cube_with_lighting_main.c
        }
    ...
    // Setup Arguments
        ...
        // Lighting inputs for fragment shader path
        pixel_args->threeDVertTrans = tVerts;
        pixel_args->camera = *camera_C;
        pixel_args->sphere_center = *Oa;
        pixel_args->light_pos = (vector_t){15.0f, 15.0f, 0.0f};
        pixel_args->albedo = (vec4_t){1.0f, 0.2f, 0.2f, 1.0f};
    ...
    char fname[30];
    snprintf(fname, sizeof(fname), "build/output/cube_lit_%03d.ppm", frame);
