...
# RFC steals these architectural registers from the general MRF pool.
RFC_RESERVED_REGS = (R61, R62)

_mrf_allocatable_regs = [
    R9,
    R10,
    R11,
    R12,
...
MRF_ALLOCATABLE_REGS = [
    reg for reg in _mrf_allocatable_regs if reg not in RFC_RESERVED_REGS
]
