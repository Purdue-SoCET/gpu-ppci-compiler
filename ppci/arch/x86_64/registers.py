...
register_classes = [
    ...
    RegisterClass("reg8", [ir.i8, ir.u8], Register8, [al, bl, cl, dl]),
    RegisterClass(
        "regfp32", [ir.f32], XmmRegisterSingle, XmmRegisterSingle.registers
    ),
    RegisterClass(
        "regfp64", [ir.f64], XmmRegisterDouble, XmmRegisterDouble.registers
    ),
]
