...
def make_rm_reg64(mnemonic, opcode, read_op1=True, write_op1=True):
    ...
    members = {"syntax": syntax, "rm": rm, "reg": reg, "opcode": opcode}
...
class InstructionCollection:
    ...
    def __init__(self, bits):
        ...
        rm_modes = {16: rm16_modes, 32: rm32_modes, 64: rm64_modes}[bits]
...
def peephole_jump_label(a, b):
    print("PH", a, b)
    if isinstance(a, NearJump) and isinstance(b, Label) and a.target == b.name:
        return [b]
    return [a, b]
