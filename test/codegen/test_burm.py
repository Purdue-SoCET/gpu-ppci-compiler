...
class BurgTestCase(unittest.TestCase):
    def test_sample4(self):
        ...
        class MyMatcher(Matcher):  # noqa: F821 class is generated by exec.
            def __init__(self):
                super().__init__()
                self.trace = []
...
class TreeMatchingTestCase(unittest.TestCase):
    ...
    def test_simple_match(self):
        ...
        system.add_rule(
            "val", Tree("VAL"), 1, None, lambda ctx, tree: tree.value
        )
        system.check()
    ...
    def test_chain_rule(self):
        ...
        system.add_rule("expr", Tree("val"), 0, None, lambda ctx, tree, c0: c0)
        system.add_rule("val", Tree("ival"), 0, None, lambda ctx, tree, c0: c0)
        system.add_rule(
            "ival", Tree("VAL"), 1, None, lambda ctx, tree: tree.value
        )
        system.check()
        selector = TreeSelector(system)
        v = selector.gen(context, tree)
    ...
    def test_mutual_recurive_chain_rule(self):
        ...
        system.add_rule(
            "val", Tree("expr"), 1, None, lambda ctx, tree: tree.value
        )
        system.check()
