...
html_sidebars = {
    "**": ["about.html", "navigation.html", "sidebar.html", "searchbox.html"]
}
...
man_pages = [("index", "ppci", "ppci Documentation", ["Windel Bouwman"], 1)]
